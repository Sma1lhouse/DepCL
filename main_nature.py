...
from trainer.default_trainer_nature import train, test_model  # , test_model_with_ttc
...
if __name__ == "__main__":
    ...
    # parser.add_argument("--first_year_model_path", type = str, default = "log/PEMS/oneline_st_an_pems-43/2011/16.1382.pkl", help='specify a pretrained model root')

    # parser.add_argument("--first_year_model_path", type = str, default = "log/AIR/eac-43/2016/17.6793.pkl", help='specify a pretrained model root')
    # parser.add_argument("--first_year_model_path", type = str, default = "log/PEMS/eac-43/2011/14.8202.pkl", help='specify a pretrained model root')

    data = 'PEMS'
    a = 'oneline_st_nn_pems-43'
    b= '2011'
    c = '16.3117.pkl'
    parser.add_argument("--first_year_model_path", type = str, default = "log/{}/{}/{}/{}".format(data,a,b,c), help='specify a pretrained model root')
    ...
    args.tcn_type = 'conv'  # conv rec attn
