...
from src.model.model_nature import TrafficStream_Model, STKEC_Model
...
if __name__ == "__main__":
    ...
    parser.add_argument("--first_year_model_path", type = str, default = "log/ENERGY-Wind/stkec-43/0/2.9916.pkl", help='specify a pretrained model root')
